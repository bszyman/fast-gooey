...
[Route("Workspaces/{workspaceId:guid}/Interfaces/tvOS/Form")]
public class AppleTvFormController(
    ILogger<AppleTvFormController> logger,
    ...
    BaseInterfaceController(keyValueService, dbContext)
{
    ...
    public IActionResult Workspace(string interfaceId)
    {
        ...
        return PartialView("~/Views/AppleTvForm/Workspace.cshtml");
    }
    ...
    public async Task<IActionResult> CreateInterface()
    {
        ...
        return PartialView("~/Views/AppleTvForm/Index.cshtml");
    }
}
