...
[Route("Workspaces/{workspaceId:guid}/Interfaces/tvOS/ProductBundle")]
public class AppleTvProductBundleController(
    ILogger<AppleTvProductBundleController> logger,
    ...
    BaseInterfaceController(keyValueService, dbContext)
{
    ...
    public IActionResult Workspace(string interfaceId)
    {
        ...
        return PartialView("~/Views/AppleTvProductBundle/Workspace.cshtml");
    }
    ...
    public async Task<IActionResult> CreateInterface()
    {
        ...
        var contentNode = new GooeyInterface
        {
            ...
            Workspace = workspace,
            Platform = "AppleTv",
            ViewType = "ProductBundle",
            Name = "New Product Bundle Interface",
        ...
        return PartialView("~/Views/AppleTvProductBundle/Index.cshtml");
    }
}
