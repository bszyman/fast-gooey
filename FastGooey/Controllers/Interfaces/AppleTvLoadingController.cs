...
[Route("Workspaces/{workspaceId:guid}/Interfaces/tvOS/Loading")]
public class AppleTvLoadingController(
    ILogger<AppleTvLoadingController> logger,
    ...
    BaseInterfaceController(keyValueService, dbContext)
{
    ...
    public IActionResult Workspace(string interfaceId)
    {
        ...
        return PartialView("~/Views/AppleTvLoading/Workspace.cshtml");
    }
    ...
    public async Task<IActionResult> CreateInterface()
    {
        ...
        return PartialView("~/Views/AppleTvLoading/Index.cshtml");
    }
}
