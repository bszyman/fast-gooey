...
[Route("Workspaces/{workspaceId:guid}/Interfaces/tvOS/Div")]
public class AppleTvDivController(
    ILogger<AppleTvDivController> logger,
    ...
    BaseInterfaceController(keyValueService, dbContext)
{
    ...
    public IActionResult Workspace(string interfaceId)
    {
        ...
        return PartialView("~/Views/AppleTvDiv/Workspace.cshtml");
    }
    ...
    public async Task<IActionResult> CreateInterface()
    {
        ...
        return PartialView("~/Views/AppleTvDiv/Index.cshtml");
    }
}
