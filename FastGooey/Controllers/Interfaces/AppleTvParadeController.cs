...
[Route("Workspaces/{workspaceId:guid}/Interfaces/tvOS/Parade")]
public class AppleTvParadeController(
    ILogger<AppleTvParadeController> logger,
    ...
    BaseInterfaceController(keyValueService, dbContext)
{
    ...
    public IActionResult Workspace(string interfaceId)
    {
        ...
        return PartialView("~/Views/AppleTvParade/Workspace.cshtml");
    }
    ...
    public async Task<IActionResult> CreateInterface()
    {
        ...
        return PartialView("~/Views/AppleTvParade/Index.cshtml");
    }
}
