...
[Route("Workspaces/{workspaceId:guid}/Interfaces/tvOS/Rating")]
public class AppleTvRatingController(
    ILogger<AppleTvRatingController> logger,
    ...
    BaseInterfaceController(keyValueService, dbContext)
{
    ...
    public IActionResult Workspace(string interfaceId)
    {
        ...
        return PartialView("~/Views/AppleTvRating/Workspace.cshtml");
    }
    ...
    public async Task<IActionResult> CreateInterface()
    {
        ...
        return PartialView("~/Views/AppleTvRating/Index.cshtml");
    }
}
