...
[Route("Workspaces/{workspaceId:guid}/Interfaces/tvOS/Search")]
public class AppleTvSearchController(
    ILogger<AppleTvSearchController> logger,
    ...
    BaseInterfaceController(keyValueService, dbContext)
{
    ...
    public IActionResult Workspace(string interfaceId)
    {
        ...
        return PartialView("~/Views/AppleTvSearch/Workspace.cshtml");
    }
    ...
    public async Task<IActionResult> CreateInterface()
    {
        ...
        return PartialView("~/Views/AppleTvSearch/Index.cshtml");
    }
}
