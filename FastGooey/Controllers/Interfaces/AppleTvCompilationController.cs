...
[Route("Workspaces/{workspaceId:guid}/Interfaces/tvOS/Compilation")]
public class AppleTvCompilationController(
    ILogger<AppleTvCompilationController> logger,
    ...
    BaseInterfaceController(keyValueService, dbContext)
{
    ...
    public IActionResult Workspace(string interfaceId)
    {
        ...
        return PartialView("~/Views/AppleTvCompilation/Workspace.cshtml");
    }
    ...
    public async Task<IActionResult> CreateInterface()
    {
        ...
        var contentNode = new GooeyInterface
        {
            ...
            Workspace = workspace,
            Platform = "AppleTv",
            ViewType = "Compilation",
            Name = "New Compilation Interface",
        ...
        return PartialView("~/Views/AppleTvCompilation/Index.cshtml");
    }
}
