...
[Route("Workspaces/{workspaceId:guid}/Interfaces/tvOS/Catalog")]
public class AppleTvCatalogController(
    ILogger<AppleTvCatalogController> logger,
    ...
    BaseInterfaceController(keyValueService, dbContext)
{
    ...
    public IActionResult Workspace(string interfaceId)
    {
        ...
        return PartialView("~/Views/AppleTvCatalog/Workspace.cshtml");
    }
    ...
    public async Task<IActionResult> CreateInterface()
    {
        ...
        return PartialView("~/Views/AppleTvCatalog/Index.cshtml");
    }
}
