...
[Route("Workspaces/{workspaceId:guid}/Interfaces/tvOS/MenuBar")]
public class AppleTvMenuBarController(
    ILogger<AppleTvMenuBarController> logger,
    ...
    BaseInterfaceController(keyValueService, dbContext)
{
    ...
    public IActionResult Workspace(string interfaceId)
    {
        ...
        return PartialView("~/Views/AppleTvMenuBar/Workspace.cshtml");
    }
    ...
    public async Task<IActionResult> CreateInterface()
    {
        ...
        return PartialView("~/Views/AppleTvMenuBar/Index.cshtml");
    }
}
