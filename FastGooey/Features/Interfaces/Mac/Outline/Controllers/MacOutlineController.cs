...
namespace FastGooey.Features.Interfaces.Mac.Outline.Controllers;
    ...
    BaseInterfaceController(keyValueService, dbContext)
{
    ...
    public async Task<IActionResult> EditorPanel(string interfaceId, Guid itemId)
    {
        ...
        return PartialView("Partials/OutlineViewItemEditorPanel", viewModel);
    }
        ...
        [FromForm] MacOutlineEditorPanelFormModel formModel)
    {
        ...
        if (!ModelState.IsValid)
        {
            ...
            return PartialView("Partials/OutlineViewItemEditorPanel", invalidModel);
        }
