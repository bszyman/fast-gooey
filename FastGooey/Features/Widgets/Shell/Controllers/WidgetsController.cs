...
using FastGooey.Features.Widgets.Shell.Models.ViewModels;
...
namespace FastGooey.Features.Widgets.Shell.Controllers;
    ...
    BaseStudioController(keyValueService, dbContext)
{
    ...
    public async Task<IActionResult> InterfaceSelector(Guid workspaceId)
    {
        ...
        return PartialView("Partials/InterfaceSelector", viewModel);
    }
